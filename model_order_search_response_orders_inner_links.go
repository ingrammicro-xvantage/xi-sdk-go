...
// checks if the OrderSearchResponseOrdersInnerLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderSearchResponseOrdersInnerLinks{}
...
func NewOrderSearchResponseOrdersInnerLinks() *OrderSearchResponseOrdersInnerLinks {
	this := OrderSearchResponseOrdersInnerLinks{}
	return &this
}
...
type NullableOrderSearchResponseOrdersInnerLinks struct {
	value *OrderSearchResponseOrdersInnerLinks
	isSet bool
}

func (v NullableOrderSearchResponseOrdersInnerLinks) Get() *OrderSearchResponseOrdersInnerLinks {
	return v.value
}

func (v *NullableOrderSearchResponseOrdersInnerLinks) Set(val *OrderSearchResponseOrdersInnerLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderSearchResponseOrdersInnerLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderSearchResponseOrdersInnerLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderSearchResponseOrdersInnerLinks(val *OrderSearchResponseOrdersInnerLinks) *NullableOrderSearchResponseOrdersInnerLinks {
	return &NullableOrderSearchResponseOrdersInnerLinks{value: val, isSet: true}
}

func (v NullableOrderSearchResponseOrdersInnerLinks) MarshalJSON() ([]byte, error) {
