...
// checks if the OrderDetailResponseEndUserInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderDetailResponseEndUserInfo{}

// OrderDetailResponseEndUserInfo The contact information for the end user/customer provided by the reseller. Used to determine pricing and discounts.
type OrderDetailResponseEndUserInfo struct {
...
func NewOrderDetailResponseEndUserInfo() *OrderDetailResponseEndUserInfo {
	this := OrderDetailResponseEndUserInfo{}
	return &this
}
...
func (o OrderDetailResponseEndUserInfo) MarshalJSON() ([]byte, error) {
...
func (o OrderDetailResponseEndUserInfo) ToMap() (map[string]interface{}, error) {
...
type NullableOrderDetailResponseEndUserInfo struct {
	value *OrderDetailResponseEndUserInfo
	isSet bool
}

func (v NullableOrderDetailResponseEndUserInfo) Get() *OrderDetailResponseEndUserInfo {
	return v.value
}

func (v *NullableOrderDetailResponseEndUserInfo) Set(val *OrderDetailResponseEndUserInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderDetailResponseEndUserInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderDetailResponseEndUserInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderDetailResponseEndUserInfo(val *OrderDetailResponseEndUserInfo) *NullableOrderDetailResponseEndUserInfo {
	return &NullableOrderDetailResponseEndUserInfo{value: val, isSet: true}
}

func (v NullableOrderDetailResponseEndUserInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderDetailResponseEndUserInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
