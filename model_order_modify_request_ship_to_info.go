...
// checks if the OrderModifyRequestShipToInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderModifyRequestShipToInfo{}
...
func NewOrderModifyRequestShipToInfo() *OrderModifyRequestShipToInfo {
	this := OrderModifyRequestShipToInfo{}
	return &this
}
...
type NullableOrderModifyRequestShipToInfo struct {
	value *OrderModifyRequestShipToInfo
	isSet bool
}

func (v NullableOrderModifyRequestShipToInfo) Get() *OrderModifyRequestShipToInfo {
	return v.value
}

func (v *NullableOrderModifyRequestShipToInfo) Set(val *OrderModifyRequestShipToInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderModifyRequestShipToInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderModifyRequestShipToInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderModifyRequestShipToInfo(val *OrderModifyRequestShipToInfo) *NullableOrderModifyRequestShipToInfo {
	return &NullableOrderModifyRequestShipToInfo{value: val, isSet: true}
}
