...
// checks if the AsyncOrderCreateDTOEndUserInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AsyncOrderCreateDTOEndUserInfo{}

// AsyncOrderCreateDTOEndUserInfo The contact information for the end user/customer provided by the reseller. Used to determine pricing and discounts.
type AsyncOrderCreateDTOEndUserInfo struct {
...
func NewAsyncOrderCreateDTOEndUserInfo() *AsyncOrderCreateDTOEndUserInfo {
	this := AsyncOrderCreateDTOEndUserInfo{}
	return &this
}
...
func (o AsyncOrderCreateDTOEndUserInfo) MarshalJSON() ([]byte, error) {
...
func (o AsyncOrderCreateDTOEndUserInfo) ToMap() (map[string]interface{}, error) {
...
type NullableAsyncOrderCreateDTOEndUserInfo struct {
	value *AsyncOrderCreateDTOEndUserInfo
	isSet bool
}

func (v NullableAsyncOrderCreateDTOEndUserInfo) Get() *AsyncOrderCreateDTOEndUserInfo {
	return v.value
}

func (v *NullableAsyncOrderCreateDTOEndUserInfo) Set(val *AsyncOrderCreateDTOEndUserInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableAsyncOrderCreateDTOEndUserInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableAsyncOrderCreateDTOEndUserInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAsyncOrderCreateDTOEndUserInfo(val *AsyncOrderCreateDTOEndUserInfo) *NullableAsyncOrderCreateDTOEndUserInfo {
	return &NullableAsyncOrderCreateDTOEndUserInfo{value: val, isSet: true}
}

func (v NullableAsyncOrderCreateDTOEndUserInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAsyncOrderCreateDTOEndUserInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
